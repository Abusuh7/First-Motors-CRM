...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"
        integrity="sha512-example" crossorigin="anonymous" />
...
<body>
    ...
    {{-- Prompt for users to signin --}}
    <div id="promptUserContainer" class=" hidden fixed  inset-0 flex justify-center items-center">
        {{-- <div class="max-w-sm mx-auto bg-white p-6 rounded-lg w-2/4 relative">
                <button id="hideSigninPromptButton"  class="absolute top-0 left-0 p-2 text-gray-600 hover:text-gray-800">
              <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M14.354 5.354a2 2 0 00-2.828 0L10 7.172 8.172 5.354a2 2 0 10-2.828 2.828L7.172 10l-1.828 1.828a2 2 0 102.828 2.828L10 12.828l1.828 1.828a2 2 0 102.828-2.828L12.828 10l1.828-1.828a2 2 0 000-2.828z" clip-rule="evenodd" />
              </svg>
            </button>
        ...
        <div class="relative w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <button id="hideSigninPromptButton" type="button"
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Signin to continue</h3>
                    @if (Route::has('login'))
                        @auth
                            <a href="{{ url('/redirects') }}"><button data-modal-hide="popup-modal" type="button"
                                    class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                    Login
                                </button></a>
                        @else
                            <a href="{{ route('login') }}"><button data-modal-hide="popup-modal" type="button"
                                    class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                    SignUp
                                </button></a>
                            <button id="hideSigninPromptButton2" data-modal-hide="popup-modal" type="button"
    ...
    <!-- header -->
    <header class="py-4 shadow-sm bg-gray-200">
        <div class="container flex items-center justify-between">
            <a href="#">
                <h1 id="logotext">FIRST MOTORS</h1>
            </a>
        ...
        <div class="container flex h-16">
            <div id="baricon"
                ...
                <div
                    ...
                    <a href="#" class="flex items-center px-6 py-3 hover:bg-gray-100 transition">
                        ...
                        <span class="ml-6 text-gray-600 text-sm">Hyper</span>
                    </a>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between flex-grow md:pl-12 py-5">
                <div class="flex items-center space-x-6 capitalize">
                    <button id="showSigninPromptButton"
                        class="text-gray-200 hover:text-white transition">Home</button>
                    <button id="showSigninPromptButton"
                        class="text-gray-200 hover:text-white transition">Shop</button>
                    <button id="showSigninPromptButton" class="text-gray-200 hover:text-white transition">Booking</button>
                    <button id="showSigninPromptButton" class="text-gray-200 hover:text-white transition">Contact
                        us</button>
                </div>
                @if (Route::has('login'))
                    <div class=" sm:right-0 p-3 text-right z-10">
                        @auth
                            <b><a href="{{ url('/redirects') }}"
                                    class="font-semibold text-gray-300 hover:text-white ">login</a></b>
                        @else
                            <b><a href="{{ route('login') }}"
                                    class="text-gray-300 hover:text-white transition">SignUp</a></b>

                            <b><span style="color: white">/</span></b>

                            @if (Route::has('register'))
                                <b><a href="{{ route('register') }}"
                                        class="text-gray-300 hover:text-white transition">Register</a></b>
                            @endif
                        @endauth
                    </div>
                @endif
    ...
    <script>
        ...
        const closePromptButton = document.getElementById('hideSigninPromptButton');

        closePromptButton.addEventListener('click', () => {
            signinPromptContainer.classList.add('hidden');
        });

        const closePromptButton1 = document.getElementById('hideSigninPromptButton2');

        closePromptButton1.addEventListener('click', () => {
            signinPromptContainer.classList.add('hidden');
        });
