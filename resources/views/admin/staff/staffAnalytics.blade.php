<x-app-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-8 mt-6 mx-3">
        ...
        <div class="flex flex-col items-center">
                ...
                <table class="w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="bg-gray-800 text-white py-2 px-4"><i class="fa fa-user"></i> Vehicles Sold</th>
            ...
            <br><br><br>
            <h1 class="text-center mb-4 bg-slate-700 text-white w-full">Other Staffs</h1>
            <div class="w-full">
                <table class="w-full">
                    <thead>
                        <tr>
