<nav x-data="{ open: false }" class="bg-gray-800">
    ...
    <div class="container flex h-16">
        <div id="baricon" class="px-8 py-4 bg-primary md:flex items-center cursor-pointer relative group hidden">
        ...
        <div class="flex items-center justify-between flex-grow md:pl-12 py-5">
            <div class="flex items-center space-x-6 capitalize">
                ...
                <a href="{{ route('adminVehiclesDashboard') }}"><button id=""
                        class="text-gray-200 hover:text-white transition font-semibold">Vehicles</button></a>

                <a href="{{ route('adminBookingDashboard') }}"><button id=""
                ...
                {{-- <x-nav-link href="{{ route('adminHome') }}" :active="request()->routeIs('adminhome')">
                        ...
                        <x-nav-link href="{{ route('adminBookingDashboard') }}" :active="request()->routeIs('adminBookingDashboard')">
                            {{ __('Booking') }}
                            @if ($user_booking_count > 0)
                                <span
                                    class="absolute  right-0  transform translate-x-2 -translate-y-2 inline-flex items-center justify-center w-4 h-4 text-xs font-semibold text-blue-800 bg-blue-200 rounded-full">
